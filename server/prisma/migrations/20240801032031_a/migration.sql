...
-- CreateTable
CREATE TABLE "Cisco_Acknowledgments" (
    "id" TEXT NOT NULL,
    "summary" TEXT NOT NULL,
    "ciscoDocumentId" TEXT NOT NULL,

    CONSTRAINT "Cisco_Acknowledgments_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Cisco_Note" (
    "id" TEXT NOT NULL,
    "category" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "text" TEXT NOT NULL,
    ...
    CONSTRAINT "Cisco_Note_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Cisco_Publisher" (
    "id" TEXT NOT NULL,
    "category" TEXT NOT NULL,
    "contact_details" TEXT NOT NULL,
    "issuing_authority" TEXT NOT NULL,
    ...
    CONSTRAINT "Cisco_Publisher_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Cisco_References" (
    "id" TEXT NOT NULL,
    "category" TEXT NOT NULL,
    "summary" TEXT NOT NULL,
    "url" TEXT NOT NULL,
    ...
    CONSTRAINT "Cisco_References_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Cisco_Tracking" (
    "id" TEXT NOT NULL,
    "current_release_date" TEXT NOT NULL,
    ...
    CONSTRAINT "Cisco_Tracking_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Cisco_Tracking_Generator" (
    "id" TEXT NOT NULL,
    "date" TEXT NOT NULL,
    "ciscoTrackingId" TEXT NOT NULL,

    CONSTRAINT "Cisco_Tracking_Generator_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Cisco_Tracking_Generator_Engine" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "ciscoTrackingGeneratorId" TEXT NOT NULL,

    CONSTRAINT "Cisco_Tracking_Generator_Engine_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Cisco_Tracking_Revision_History" (
    "id" TEXT NOT NULL,
    "date" TEXT NOT NULL,
    ...
    CONSTRAINT "Cisco_Tracking_Revision_History_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "Cisco_Vulnerabilities_Product_Notes" (
    "id" TEXT NOT NULL,
    "known_affected" TEXT[],
    "ciscoVulnerabilitiesId" TEXT NOT NULL,

    CONSTRAINT "Cisco_Vulnerabilities_Product_Notes_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Acknowledgments_id_key" ON "Cisco_Acknowledgments"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Note_id_key" ON "Cisco_Note"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Publisher_id_key" ON "Cisco_Publisher"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Publisher_ciscoDocumentId_key" ON "Cisco_Publisher"("ciscoDocumentId");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_References_id_key" ON "Cisco_References"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_References_ciscoDocumentId_key" ON "Cisco_References"("ciscoDocumentId");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_id_key" ON "Cisco_Tracking"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_ciscoDocumentId_key" ON "Cisco_Tracking"("ciscoDocumentId");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_Generator_id_key" ON "Cisco_Tracking_Generator"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_Generator_ciscoTrackingId_key" ON "Cisco_Tracking_Generator"("ciscoTrackingId");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_Generator_Engine_id_key" ON "Cisco_Tracking_Generator_Engine"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_Generator_Engine_ciscoTrackingGeneratorId_key" ON "Cisco_Tracking_Generator_Engine"("ciscoTrackingGeneratorId");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_Revision_History_id_key" ON "Cisco_Tracking_Revision_History"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Tracking_Revision_History_ciscoTrackingId_key" ON "Cisco_Tracking_Revision_History"("ciscoTrackingId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Vulnerabilities_ciscoId_key" ON "Cisco_Vulnerabilities"("ciscoId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Vulnerabilities_Product_Notes_id_key" ON "Cisco_Vulnerabilities_Product_Notes"("id");

-- CreateIndex
CREATE UNIQUE INDEX "Cisco_Vulnerabilities_Product_Notes_ciscoVulnerabilitiesId_key" ON "Cisco_Vulnerabilities_Product_Notes"("ciscoVulnerabilitiesId");
...
-- AddForeignKey
ALTER TABLE "Cisco_Acknowledgments" ADD CONSTRAINT "Cisco_Acknowledgments_ciscoDocumentId_fkey" FOREIGN KEY ("ciscoDocumentId") REFERENCES "Cisco_Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cisco_Note" ADD CONSTRAINT "Cisco_Note_ciscoDocumentId_fkey" FOREIGN KEY ("ciscoDocumentId") REFERENCES "Cisco_Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cisco_Publisher" ADD CONSTRAINT "Cisco_Publisher_ciscoDocumentId_fkey" FOREIGN KEY ("ciscoDocumentId") REFERENCES "Cisco_Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cisco_References" ADD CONSTRAINT "Cisco_References_ciscoDocumentId_fkey" FOREIGN KEY ("ciscoDocumentId") REFERENCES "Cisco_Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cisco_Tracking" ADD CONSTRAINT "Cisco_Tracking_ciscoDocumentId_fkey" FOREIGN KEY ("ciscoDocumentId") REFERENCES "Cisco_Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cisco_Tracking_Generator" ADD CONSTRAINT "Cisco_Tracking_Generator_ciscoTrackingId_fkey" FOREIGN KEY ("ciscoTrackingId") REFERENCES "Cisco_Tracking"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cisco_Tracking_Generator_Engine" ADD CONSTRAINT "Cisco_Tracking_Generator_Engine_ciscoTrackingGeneratorId_fkey" FOREIGN KEY ("ciscoTrackingGeneratorId") REFERENCES "Cisco_Tracking_Generator"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cisco_Tracking_Revision_History" ADD CONSTRAINT "Cisco_Tracking_Revision_History_ciscoTrackingId_fkey" FOREIGN KEY ("ciscoTrackingId") REFERENCES "Cisco_Tracking"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Cisco_Vulnerabilities_Product_Notes" ADD CONSTRAINT "Cisco_Vulnerabilities_Product_Notes_ciscoVulnerabilitiesId_fkey" FOREIGN KEY ("ciscoVulnerabilitiesId") REFERENCES "Cisco_Vulnerabilities"("id") ON DELETE CASCADE ON UPDATE CASCADE;
